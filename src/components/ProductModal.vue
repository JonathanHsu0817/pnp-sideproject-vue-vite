    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content border-0">
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-3">
                ...
                <input v-model="modalProduct.imageUrl" type="text" class="form-control mb-2" placeholder="請輸入圖片連結">
                <img class="img-fluid" :src="modalProduct.imagesUrl">
              </div>
              <h3 class="mb-3">多圖新增</h3>
              <div v-if="Array.isArray(modalProduct.imagesUrl)">
                <div class="mb-1" v-for="(image, key) in modalProduct.imagesUrl" :key="key">
                  <div class="mb-3">
                    <label for="imageUrl" class="form-label">圖片網址</label>
                    <input v-model="modalProduct.imagesUrl[key]" type="text" class="form-control"
                    placeholder="請輸入圖片連結">
                  </div>
                  <img class="img-fluid" :src="image">
                </div>
                <!-- 判斷多圖陣列是否空值 -->
                <div v-if="!modalProduct.imagesUrl.length || modalProduct.imagesUrl[modalProduct.imagesUrl.length - 1]">
              ...
              <div class="row">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input id="price" type="number" min="0" class="form-control"
                          placeholder="請輸入售價" v-model="modalProduct.price">
                </div>
              </div>
              <hr>
              <div class="mb-3">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" @click="$emit('updateProducts',modalProduct)">
              確認
          </button>
        </div>
      </div>
